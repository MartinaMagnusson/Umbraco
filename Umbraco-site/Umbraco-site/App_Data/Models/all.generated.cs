...
#pragma warning restore 0109
		...
		{
			get { return this.GetPropertyValue("header"); }
		}
	...
	[PublishedContentModel("artikel")]
	public partial class Artikel : Master
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "artikel";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public Artikel(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<Artikel, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
